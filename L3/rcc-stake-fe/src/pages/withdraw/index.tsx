          ...
          <Grid container sx={{
            ...
            <Grid item xs={4}>
              <Box display={'flex'} alignItems={'center'} flexDirection={'column'}>
                ...
                <Box className='val'>{ isConnected ?userData.staked: InitData.staked} ETH</Box>
              </Box>
            </Grid>
            <Grid item xs={4}>
              <Box display={'flex'} alignItems={'center'} flexDirection={'column'}>
                <Box className='title'>Available to withdraw </Box>
                <Box className='val'>{ isConnected ?userData.withdrawable: InitData.withdrawable} ETH</Box>
              </Box>
            </Grid><Grid item xs={4}>
              <Box display={'flex'} alignItems={'center'} flexDirection={'column'}>
                <Box className='title'>Pending Withdraw: </Box>
                <Box className='val'>{ isConnected ?userData.withdrawPending: InitData.withdrawPending} ETH</Box>
              </Box>
            </Grid>
          </Grid>
